...
func TestPruneModifiesQuadTreeObject(t *testing.T) {
	...
	qnNE := QuadTreeNode{}
	qnNE.Color = InterleaveColor(color.RGBA{R: 255, G: 0, B: 0, A: 0})

	qnNW := QuadTreeNode{}
	qnNW.Color = InterleaveColor(color.RGBA{R: 255, G: 0, B: 0, A: 0})

	qnSE := QuadTreeNode{}
	qnSE.Color = InterleaveColor(color.RGBA{R: 255, G: 0, B: 0, A: 0})

	qnSW := QuadTreeNode{}
	qnSW.Color = InterleaveColor(color.RGBA{R: 255, G: 0, B: 0, A: 0})
	...
	qn.Color = InterleaveColor(color.RGBA{R: 255, G: 0, B: 0, A: 0})
	...
	expectedColor := InterleaveColor(color.RGBA{R: 255, G: 0, B: 0, A: 0})
